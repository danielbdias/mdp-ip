...
execute_problem(){
	...
	current_report=$RESULTS_DIR/"report_"$problem_type"_lrtdp_enum_rnd.txt"
	current_log=$RESULTS_DIR/logs/$problem_type"_"$current_problem_index"_lrtdp_enum_rnd.log"
	initial_state_value=$RESULTS_DIR/initial_values/"initial_value"$problem_type"_"$current_problem_index"_lrtdp_enum_rnd.txt"
