...
execute_problem(){
	...
	current_report=$RESULTS_DIR/"report_"$problem_type"_rtdp_enum_min.txt"
	current_log=$RESULTS_DIR/logs/$problem_type"_"$current_problem_index"_rtdp_enum_min.log"
	initial_state_value=$RESULTS_DIR/initial_values/"initial_value"$problem_type"_"$current_problem_index"_rtdp_enum_min.txt"
