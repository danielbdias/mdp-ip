...
public class TrafficGen {
	...
	/** Constants **/
	public static final double PROB_TURN   = 0.7;
	public static final double PROB_ARRIVE = 0.25;
	...
	public static void GenTrafficFile(int size) {
		...
		try {
			...
			for (boolean b : actions) {
				...
				int o = (size << 1) - 1;
				int e = size << 1;
				os.println("r"+o+" (r"+(o-2)+" (" + _df.format(1d-PROB_ARRIVE) + ")");					
				os.println("       (r"+o+" (" + (1d-PROB_ARRIVE) + ") (0.0)))");			
				os.println("r"+e+" (r"+(e-2)+" (" + _df.format(1d-PROB_ARRIVE) + ")");					
				os.println("       (r"+e+" (" + (1d-PROB_ARRIVE) + ") (0.0)))");			
