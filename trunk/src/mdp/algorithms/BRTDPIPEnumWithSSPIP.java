...
public class BRTDPIPEnumWithSSPIP {
	...
	public static void main(String[] args) {
		...
		double tau 				= Double.parseDouble(args[5]);
		...
		myMDP.solveBRTDPIPEnum(maxTrialDepth, timeOut, tau, stateSamplingType, randomGenInitial, randomGenNextState, initialStateLogPath);
