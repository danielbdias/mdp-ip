...
// TODO:
// -----
// - Import BN functions and update BN (test)
// - Update BN d-sep to use graph routines
// - Test on theorem proving
// - Method for launching viewer
//
//////////////////////////////////////////////////////////////////////
...
public class Graph {
	...
	public boolean _bDirected; // Just used for printing, does not restrict
		   					   // links
	...
	public void genDotFile(String filename) {
		...
		try {
			...
			os.println((_bDirected ? "digraph" : "graph") + " G { ");
			...
			if (_bDirected) {
				if (_bBottomToTop) os.println("edge [dir=back];");
			} else {
				os.println("edge [dir=\"back\",fontsize=\"16\"];");
			}
