...
execute_problem(){
	...
	current_report=$RESULTS_DIR/"report_"$problem_type"_rtdp_rnd.txt"
	current_log=$RESULTS_DIR/logs/$problem_type"_"$current_problem_index"_rtdp_rnd.log"
	value_function=$RESULTS_DIR/value_functions/"valuefunction_"$problem_type"_"$current_problem_index"_rtdp_rnd.net"
	initial_state_value=$RESULTS_DIR/initial_values/"initial_value"$problem_type"_"$current_problem_index"_rtdp_rnd.txt"
