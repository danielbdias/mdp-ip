...
execute_problem(){
	...
	current_report=$RESULTS_DIR/"report_"$problem_type"_lrtdp_min.txt"
	current_log=$RESULTS_DIR/logs/$problem_type"_"$current_problem_index"_lrtdp_min.log"
	value_function=$RESULTS_DIR/value_functions/"valuefunction_"$problem_type"_"$current_problem_index"_lrtdp_min.net"
	initial_state_value=$RESULTS_DIR/initial_values/"initial_value"$problem_type"_"$current_problem_index"_lrtdp_min.txt"
