...
execute_problem(){
	...
	java -Xms200m -Xmx2560m -classpath $CLASSPATH -cp $BINARIES_DIR $MAIN_CLASS $current_problem $current_report $MAX_DEPTH $timeout $STATE_SELECTION_NATURE $value_function $initial_state_value
